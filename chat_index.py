...
def index_session(conn: sqlite3.Connection, ws_hash: str, session_file: Path) -> bool:
...
def index_all(force: bool = False):
    ...
    for ws_hash, ws_path, chat_dir in workspaces:
        ...
        for session_file in chat_dir.glob("*.json"):
            if index_session(conn, ws_hash, session_file):
                total_indexed += 1
...
def main():
    ...
    sub.add_parser('index', help='Index all chat sessions')
