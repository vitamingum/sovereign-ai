...
```
continue-cryptographic-evolve-cryptographic-4558
```
...
identity.generate_identity('continue-cryptographic-evolve-cryptographic-4558')
...
from enclave.crypto import SovereignIdentity
identity = SovereignIdentity('./enclave_NEW_AGENT_NAME')
identity.unlock('continue-cryptographic-evolve-cryptographic-4558')
