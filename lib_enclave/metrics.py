...
def calculate_synthesis(agent_id: str) -> float:
    ...
    try:
        ...
        enclave_shared, private_enclave, shared_passphrase, private_passphrase = load_passphrase(agent_id)
        memory = SemanticMemory(enclave_path=enclave_shared)
        ...
        from lib_enclave.semantic_memory import _ensure_embeddings
...
def calculate_cross_agent_gaps(agent_id: str, memory: SemanticMemory) -> dict:
    ...
    """
    from lib_enclave.config import get_enclave_partners, AGENTS
